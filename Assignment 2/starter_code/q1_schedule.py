...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        self.epsilon = self.eps_begin + min(t, self.nsteps)*(self.eps_end-self.eps_begin)/self.nsteps
...
class LinearExploration(LinearSchedule):
    ...
    def get_action(self, best_action):
        ...
        r = np.random.random() < self.epsilon
        action = self.env.action_space.sample() if r else best_action
        return action
